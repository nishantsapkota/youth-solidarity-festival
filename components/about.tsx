  ...
  return (
    <section id="about" className="bg-white py-20">
      <div className="container mx-auto px-2">
        ...
        {/* Message from the Club Section */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 0.6 }}
          className="rounded-lg bg-white p-8 shadow-sm mt-12"
        >
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-gray-100 to-pink-100 rounded-xl shadow-2xl p-6 flex flex-col items-center text-center border border-gray-200 transition-transform duration-300"
            >
